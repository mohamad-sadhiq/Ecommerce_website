...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Jost', sans-serif; }
        ...
        .btn-submit { width: 100%; background: var(--gold-accent); color: white; padding: 15px; border: none; border-radius: 3px; font-size: 12px; text-transform: uppercase; letter-spacing: 2px; font-weight: 600; cursor: pointer; transition: 0.3s; margin-top: 10px; }
    ...
    <main class="main-content">
        ...
        <div class="dashboard-container">
            <div class="page-header">
                <div>
                    <h1 class="serif-font">Edit Piece #${product.id}</h1>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="categoryId" required>
                                ...
                                <c:forEach var="category" items="${categories}">
                                    <option value="${category.id}" <c:if test="${product.category != null && product.category.id == category.id}">selected</c:if>>
                                        ${category.name}
                                    </option>
                                </c:forEach>
                            </select>
