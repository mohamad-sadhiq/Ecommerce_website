...
<head>
    ...
    <style>
        :root {
            ...
            --text-gray: #6c757d; --brand-color: #4A235A; --gold-accent: #cda53f;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Jost', sans-serif; }
        ...
        .form-group input[type="text"] { width: 100%; padding: 14px 15px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; outline: none; transition: 0.3s; background: var(--bg-main); color: var(--text-dark); }
        ...
        .btn-submit:hover { background: var(--brand-color); transform: translateY(-2px); box-shadow: 0 4px 12px rgba(74, 35, 90, 0.2); }
    </style>
</head>
<body>
